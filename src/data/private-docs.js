...
export const PRIVATE_DOCS = [
  ...
  },
  {
    ...
    watchOut: [
      '委託買賣業以外的人代辦過戶，道路交通安全規則第 16 條第 5 項要的是三份證件：'
      + '車主的國民身分證（該項寫「除繳驗第一項第一款規定之證明文件外」，指的就是這份）、'
      + '代辦人身分證，以及車主有效駕駛執照或健保卡或護照。'
      + '但書只放寬最後那一份——「汽車所有人有效之駕駛執照或全民健康保險卡或護照等證明文件」'
      + '才可以用法院或民間公證人的認證文件代替，代辦人身分證不能免。只帶一張委託書辦不成',
  ...
  },
  {
    ...
    watchOut: [
      '金額與發票年月日不能留空。票據法第 11 條第 2 項：善意執票人取得已具備應記載事項之票據時，發票人不得以原係欠缺應記載事項為由主張無效——空白交出去被填上再轉手就很難翻案',
      '金額要同時寫國字大寫與阿拉伯數字。第 7 條：文字與號碼不符時以文字為準，所以大寫那一欄才是決勝的',
      '未載到期日視為見票即付（第 120 條第 2 項）、未載受款人以執票人為受款人即無記名（第 3 項）；兩者同時成立時金額須在五百元以上（第 6 項）',
    ],
  },
  {
    ...
    watchOut: [
      '「載明授權範圍」是公司法第 177 條第 1 項的法定應記載事項，要寫到承認案、討論案、選舉案、臨時動議各授權到什麼程度，只寫「委託出席」不算',
      '一股東出具一委託書、以委託一人為限，並應於股東會開會五日前送達公司（第 177 條第 3 項）；委託書有重複時以最先送達者為準',
      '公開發行、上市、上櫃、興櫃公司不能自製：用紙以公司印發者為限，否則代理之表決權不予計算（委託書規則第 2 條、第 22 條第 1 款）',
    ],
  },
];
